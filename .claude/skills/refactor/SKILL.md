...
2. **Execute incrementally** — one logical change at a time:
   ...
   - Verify no circular imports: `uv run python -c "import <your_project>"`
...
3. **Import check:** `uv run python -c "import <your_project>"` 
...
/refactor src/<your_project>/train/trainer.py
...
# Target a directory
/refactor src/<your_project>/eval/
```
