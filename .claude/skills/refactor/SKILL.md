...
2. **Execute incrementally** — one logical change at a time:
   ...
   - Verify no circular imports: `uv run python -c "import research_workflow"`
...
3. **Import check:** `uv run python -c "import research_workflow"` 
...
/refactor src/research_workflow/train/trainer.py
...
# Target a directory
/refactor src/research_workflow/eval/
```
