...
from research_workflow.orchestrate.hub import DEFAULT_MODEL_REPO
...
def upload_model(pod: Pod, model: ModelDir, repo_id: str = DEFAULT_REPO) -> bool:
    ...
    _rc, out, err = ssh_run(
        ...
        f"cd /workspace/your-project && "
        f'uv run python -c "'
        f"from research_workflow.orchestrate.hub import upload_model; "
